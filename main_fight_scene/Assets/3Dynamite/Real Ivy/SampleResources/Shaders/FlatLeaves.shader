	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float4 appendResult87 = (float4(inputMesh.positionOS.x , inputMesh.positionOS.y , 0.0 , 0.0));
				...
				#endif
				float3 vertexValue = ( ( cos( temp_output_63_0 ) * float4( inputMesh.normalOS , 0.0 ) * _Radius * inputMesh.ase_color.a ) + ( ( sin( temp_output_63_0 ) + -1.0 ) * float4( cross( inputMesh.normalOS , inputMesh.tangentOS.xyz ) , 0.0 ) * _Radius * inputMesh.ase_color.a ) ).rgb;
						...
						)
			{
				...
				float2 texCoord118 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.Albedo = ( _Color * tex2DNode76 ).rgb;
				surfaceDescription.Normal = UnpackNormalScale( tex2D( _NormalTexture, Offset117 ), 1.0f );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( tex2D( _SpecularTexture, Offset117 ) * _Specular ).rgb;
				#endif

				surfaceDescription.Emission = 0;
				surfaceDescription.Smoothness = _Smoothness;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = tex2DNode76.a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord118 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 defaultVertexValue = float3( 0, 0, 0 );
				#endif
				float3 vertexValue = ( ( cos( temp_output_63_0 ) * float4( inputMesh.normalOS , 0.0 ) * _Radius * inputMesh.ase_color.a ) + ( ( sin( temp_output_63_0 ) + -1.0 ) * float4( cross( inputMesh.normalOS , inputMesh.ase_tangent.xyz ) , 0.0 ) * _Radius * inputMesh.ase_color.a ) ).rgb;
					...
					)
			{
				...
				float2 texCoord118 = packedInput.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord118 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 texCoord118 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18900
144;779;1706;981;2495.474;1144.685;1.6;True;True
Node;AmplifyShaderEditor.RangedFloatNode;56;-3969.887,549.0299;Float;False;Property;_Frequency;Frequency;8;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;65;-3970.744,475.5388;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;101;-3725.737,649.358;Float;False;Constant;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-2558.526,857.9333;Float;False;Property;_Center;Center;10;0;Create;True;0;0;0;False;0;False;0;-0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-2560.129,965.3518;Float;False;Constant;_Float5;Float 5;1;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;85;-2479.124,379.2203;Inherit;True;Property;_WindPattern;Wind Pattern;12;0;Create;True;0;0;0;False;0;False;-1;2d15e4a275691a645ab383c7c5724d67;2d15e4a275691a645ab383c7c5724d67;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;68;-2312.713,604.1532;Float;False;Property;_Amplitude;Amplitude;9;0;Create;True;0;0;0;False;0;False;1;0.35;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;110;-2923.407,-956.1487;Inherit;True;Property;_HeightMap;HeightMap;6;0;Create;True;0;0;0;False;0;False;-1;7162178e217d90342ba7a90c3498130e;2a256c3a8dd4fb448b777e90692a6e47;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;111;-2911.027,-745.8546;Float;False;Property;_ParallaxIntensity;Parallax Intensity;7;0;Create;True;0;0;0;False;0;False;0.01;0.0217;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-1627.301,955.1239;Float;False;Constant;_Float3;Float 3;3;0;Create;True;0;0;0;False;0;False;-1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-1359.162,663.071;Float;False;Property;_Radius;Radius;11;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;33;-1241.802,1411.873;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;104;-1704.707,-454.1123;Float;False;Property;_Specular;Specular;2;0;Create;True;0;0;0;False;0;False;0;0.137;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;106;-1709.884,-655.9253;Inherit;True;Property;_SpecularTexture;Specular Texture;3;0;Create;True;0;0;0;False;0;False;-1;2a0ee0866fd464e4b85928a591e4d625;0310cf39af27532468d205f8a6c9ebcf;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;134;-930.4792,-1213.019;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;76;-1720.486,-1208.143;Inherit;True;Property;_AlbedoTexture;AlbedoTexture;1;0;Create;True;0;0;0;False;0;False;-1;a13d0741ba1b57640b1b4b035043021f;78e19074a8af01548b8086c7aa2050b4;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;103;-1725.713,-963.9395;Inherit;True;Property;_NormalTexture;NormalTexture;5;0;Create;True;0;0;0;False;0;False;-1;67631cd853304ee45bfa2775f9c9fc9c;e929b2198f5572746876750909242f93;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;107;-1707.861,-367.3922;Float;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;1;0.388;0;1;0;1;FLOAT;0
...
WireConnection;136;5;108;0
WireConnection;136;7;107;0
WireConnection;136;9;76;4
WireConnection;136;11;37;0
ASEEND*/
//CHKSM=5B1C0F2116C64385ADF3AFB3F7FD15CC1E6E091E