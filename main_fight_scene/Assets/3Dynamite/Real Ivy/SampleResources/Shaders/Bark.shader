	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_HeightTexture = packedInput.ase_texcoord5.xy * _HeightTexture_ST.xy + _HeightTexture_ST.zw;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_HeightTexture = packedInput.ase_texcoord.xy * _HeightTexture_ST.xy + _HeightTexture_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_HeightTexture = packedInput.ase_texcoord1.xy * _HeightTexture_ST.xy + _HeightTexture_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_HeightTexture = packedInput.ase_texcoord3.xy * _HeightTexture_ST.xy + _HeightTexture_ST.zw;
				float3 ase_worldBitangent = packedInput.ase_texcoord4.xyz;
				float3 tanToWorld0 = float3( tangentWS.xyz.x, ase_worldBitangent.x, normalWS.x );
				float3 tanToWorld1 = float3( tangentWS.xyz.y, ase_worldBitangent.y, normalWS.y );
				float3 tanToWorld2 = float3( tangentWS.xyz.z, ase_worldBitangent.z, normalWS.z );
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_HeightTexture = packedInput.ase_texcoord7.xy * _HeightTexture_ST.xy + _HeightTexture_ST.zw;
...
/*ASEBEGIN
Version=18900
281;375;1706;987;2881.22;1596.528;1.839322;True;True
Node;AmplifyShaderEditor.RangedFloatNode;111;-2079.588,-691.0698;Float;False;Property;_ParallaxIntensity;Parallax Intensity;7;0;Create;True;0;0;0;False;0;False;0.01;0.0111;0;0.1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;106;-889.9819,-704.9678;Inherit;True;Property;_SpecularTexture;Specular Texture;4;0;Create;True;0;0;0;False;0;False;-1;2a0ee0866fd464e4b85928a591e4d625;88888d9eb7319704b9bf5c29ff3a1b61;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;104;-884.804,-503.1548;Float;False;Property;_Specular;Specular;3;0;Create;True;0;0;0;False;0;False;0;0.6;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;76;-889.047,-1153.358;Inherit;True;Property;_AlbedoTexture;Albedo Texture;1;0;Create;True;0;0;0;False;0;False;-1;a13d0741ba1b57640b1b4b035043021f;6e9d3f1e2b5c9274fa0899a7ea119a13;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;119;-800.9883,-1382.099;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;107;-887.9587,-416.4347;Float;False;Property;_Smoothness;Smoothness;5;0;Create;True;0;0;0;False;0;False;1;0.323;0;1;0;1;FLOAT;0
...
WireConnection;127;1;103;0
WireConnection;127;5;108;0
WireConnection;127;7;107;0
WireConnection;127;9;76;4
ASEEND*/
//CHKSM=8CE1878D8155073C9037A2FF34A4BD567D85800D