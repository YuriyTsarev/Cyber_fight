	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_SpecularTexture = packedInput.ase_texcoord5.xy * _SpecularTexture_ST.xy + _SpecularTexture_ST.zw;
				
				surfaceDescription.Albedo = tex2DNode76.rgb;
				...
				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( tex2D( _SpecularTexture, uv_SpecularTexture ) * _Specular ).rgb;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 uv_SpecularTexture = packedInput.ase_texcoord.xy * _SpecularTexture_ST.xy + _SpecularTexture_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_SpecularTexture = packedInput.ase_texcoord7.xy * _SpecularTexture_ST.xy + _SpecularTexture_ST.zw;
...
/*ASEBEGIN
Version=18900
144;779;1706;981;2192.945;1511.98;1.941114;True;True
...
Node;AmplifyShaderEditor.SamplerNode;103;-1725.713,-963.9395;Inherit;True;Property;_NormalTexture;Normal Texture;1;0;Create;True;0;0;0;False;0;False;-1;67631cd853304ee45bfa2775f9c9fc9c;e929b2198f5572746876750909242f93;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
